...
import {
  ...
  Upload, ChevronRight, Check, AlertCircle, Loader2
} from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-50 border border-teal-100 mb-4">
            ...
            <span className="text-teal-700 font-medium">Hospital Registration</span>
          </div>
          ...
          <p className="text-slate-600">
            ...
            <span className="font-semibold text-teal-600">{PLAN_NAMES[selectedPlan]}</span>
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
          ...
          {step === 1 && (
            <div className="p-8">
              <h2 className="text-xl font-bold text-slate-900 mb-6">Hospital Details</h2>
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500"
                  />
                </div>
          ...
          {step === 4 && (
            <div className="p-8">
              <h2 className="text-xl font-bold text-slate-900 mb-6">Specialties & Review</h2>
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-3">
                    Key Specialties (Select all that apply)
                  </label>
                  <div className="flex flex-wrap gap-2">
                ...
                <div className="bg-slate-50 rounded-2xl p-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium text-slate-900">{formData.hospitalName || '-'}</p>
                    </div>
                    <div>
                      <p className="text-slate-500">Type</p>
                      <p className="font-medium text-slate-900">
                        {HOSPITAL_TYPES.find(t => t.value === formData.hospitalType)?.label || '-'}
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-medium text-teal-600">{PLAN_NAMES[selectedPlan]}</p>
                    </div>
                  </div>
                </div>
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-slate-600">
                    ...
                    . I confirm that I am authorized to register this hospital on AIHealz.
                  </span>
                </label>
              </div>
            </div>
          ...
          <div className="px-8 py-5 bg-slate-50 border-t border-slate-200 flex items-center justify-between">
            ...
            {step < 4 ? (
              <button
                onClick={nextStep}
                className="flex items-center gap-2 px-6 py-2.5 bg-teal-600 text-white rounded-xl font-semibold hover:bg-teal-700 transition-colors"
              >
                Continue
